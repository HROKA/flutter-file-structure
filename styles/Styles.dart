...
class Styles {
  ...
  Styles({
    ...
    this.raduisColor = Constants.PRIMARY_COLOR,
    this.fontColor = BLACK_COLOR,
    this.underLineColor = BLACK_COLOR,
    this.svgColor = Constants.PRIMARY_COLOR,
    this.edgeTextColor = Constants.PRIMARY_COLOR,
    this.titleFontColor = Constants.GREY_COLOR,
    ...
    this.shadowColor = Constants.GREY_COLOR,
